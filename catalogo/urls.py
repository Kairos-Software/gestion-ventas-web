...
urlpatterns = [
    ...
    path('config/directo-hero-pieza1-imagen/', views_config.CatalogoConfigDirectoHeroImagenAjax.as_view(numero=1), name='config_directo_hero_imagen1'),
    path('config/directo-hero-pieza2-imagen/', views_config.CatalogoConfigDirectoHeroImagenAjax.as_view(numero=2), name='config_directo_hero_imagen2'),
    path('config/directo-hero-pieza3-imagen/', views_config.CatalogoConfigDirectoHeroImagenAjax.as_view(numero=3), name='config_directo_hero_imagen3'),
    ...
    path('config/gondolas-almacen/guardar/', views_config.CatalogoGondolaAlmacenGuardarAjax.as_view(), name='config_gondola_almacen_guardar'),
    path('config/gondolas-almacen/eliminar/', views_config.CatalogoGondolaAlmacenEliminarAjax.as_view(), name='config_gondola_almacen_eliminar'),
    ...
    path('config/bitacora-kinetic/guardar/', views_config.CatalogoBitacoraKineticGuardarAjax.as_view(), name='config_bitacora_kinetic_guardar'),
    path('config/bitacora-kinetic/eliminar/', views_config.CatalogoBitacoraKineticEliminarAjax.as_view(), name='config_bitacora_kinetic_eliminar'),
    path('config/consultas-kinetic/guardar/', views_config.CatalogoConsultaKineticGuardarAjax.as_view(), name='config_consulta_kinetic_guardar'),
    path('config/consultas-kinetic/eliminar/', views_config.CatalogoConsultaKineticEliminarAjax.as_view(), name='config_consulta_kinetic_eliminar'),
    path('config/selecciones-editorial/guardar/', views_config.CatalogoSeleccionEditorialGuardarAjax.as_view(), name='config_seleccion_editorial_guardar'),
    path('config/selecciones-editorial/imagen/', views_config.CatalogoSeleccionEditorialImagenAjax.as_view(), name='config_seleccion_editorial_imagen'),
    path('config/selecciones-editorial/eliminar/', views_config.CatalogoSeleccionEditorialEliminarAjax.as_view(), name='config_seleccion_editorial_eliminar'),
