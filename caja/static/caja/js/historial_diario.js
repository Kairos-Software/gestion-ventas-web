function htEliminarHistorial() {
    ...
    if (!confirm('¿Estás seguro de eliminar TODO el historial de turnos? Esta acción no se puede deshacer.')) {
        return;
    }
    if (!confirm('Esta acción eliminará ' + cantidad + ' turnos. ¿Continuar?')) {
        return;
    }
